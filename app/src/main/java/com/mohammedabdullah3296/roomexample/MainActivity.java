...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().hasExtra("id")) {
            ...
            new GetUser(MainActivity.this, id).execute();
        }
            ...
            public void onClick(View v) {
                ...
                if (getIntent().hasExtra("id")) {
                    if (0 != firstName.length() && 0 != lastName.length()) {
                        ...
                        new UpdateUser(MainActivity.this, u).execute();
                    } else {
                        Toast.makeText(MainActivity.this, "Please enter first name and last name.", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    if (0 != firstName.length() && 0 != lastName.length()) {
                        User u = new User();
                        ...
                        new AddUser(MainActivity.this, u).execute();
                    } else {
                        Toast.makeText(MainActivity.this, "Please enter first name and last name.", Toast.LENGTH_SHORT).show();
                    }
                }
